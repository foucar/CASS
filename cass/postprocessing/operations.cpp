...
// ********** Postprocessor 402: median of last values ************

cass::pp402::pp402(PostProcessors& pp, const cass::PostProcessors::key_t &key)
  : PostprocessorBackend(pp, key), _medianStorage(NULL)
{
  loadSettings(0);
}

void cass::pp402::loadSettings(size_t)
{
  CASSSettings settings;
...
void cass::pp402::process(const CASSEvent &evt)
{
  // Get the input
  using namespace std;
  const HistogramFloatBase &one
