...
SOAPFiles.commands  = [ -r soapCASSsoapService.h ] && [ `find $$PWD/../cass/soapserver.h -newer soapCASSsoapService.h | grep -c soapserver` > "0" ] || soapcpp2 -C -i $$PWD/../cass/soapserver.h 
