...
class QwtLogColorMap::ColorStops
{
public:
    ColorStops()
    {
    ...
    QRgb rgb(QwtLogColorMap::Mode, double pos) const;
...
void QwtLogColorMap::ColorStops::insert(double pos, const QColor &color)
{
...
inline QwtArray<double> QwtLogColorMap::ColorStops::stops() const
{
...
inline int QwtLogColorMap::ColorStops::findUpper(double pos) const
{
    int index = 0;
    int n = _stops.size();
...
inline QRgb QwtLogColorMap::ColorStops::rgb(
    QwtLogColorMap::Mode mode, double pos) const
{
    if ( pos <= 0.0 )
        return _stops[0].rgb;
    if ( pos >= 1.0 )
...
class QwtLogColorMap::PrivateData
{
public:
    ColorStops colorStops;
    QwtLogColorMap::Mode mode;
};
...
//! Destructor
QwtLogColorMap::~QwtLogColorMap()
{
    delete d_data;
}

//! Assignment operator
QwtLogColorMap &QwtLogColorMap::operator=(
    const QwtLogColorMap &other)
{
...
//! Clone the color map
QwtColorMap *QwtLogColorMap::copy() const
{
    QwtLogColorMap* map = new QwtLogColorMap();
    *map = *this;
...
/*!
   ...
   \sa mode()
*/
void QwtLogColorMap::setMode(Mode mode)
{
    d_data->mode = mode;
}
...
/*!
   ...
   \sa setMode()
*/
QwtLogColorMap::Mode QwtLogColorMap::mode() const
{
    return d_data->mode;
}
...
/*!
   ...
   \sa color1(), color2()
*/
void QwtLogColorMap::setColorInterval(
...
*/
void QwtLogColorMap::addColorStop(double value, const QColor& color)
{
...
*/
QwtArray<double> QwtLogColorMap::colorStops() const
{
...
/*! 
  ...
  \sa setColorInterval()
*/
QColor QwtLogColorMap::color1() const
{
...
/*! 
  ...
  \sa setColorInterval()
*/
QColor QwtLogColorMap::color2() const
{
