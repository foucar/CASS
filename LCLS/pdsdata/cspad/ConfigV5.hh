#ifndef Cspad_ConfigV5_hh
#define Cspad_ConfigV5_hh
...
#include "Detector.hh"
#include "ConfigV3.hh" // for the protection system thresholds
#include "ConfigV3QuadReg.hh"
  ...
  namespace CsPad
  {
    ...
    class ConfigV5
    {
      public:
        ...
        ConfigV3QuadReg*                 quads        ()       { return _quads; }
        const ConfigV3QuadReg*           quads        () const { return _quads; }
        ...
        ProtectionSystemThreshold*       protectionThresholds ()       { return _protectionThresholds; }
        const ProtectionSystemThreshold* protectionThresholds () const { return _protectionThresholds; }
        ...
        uint32_t                         internalTriggerDelay() {return _internalTriggerDelay; }
        const uint32_t                   internalTriggerDelay() const {return _internalTriggerDelay; }
        void                             internalTriggerDelay( uint32_t d ) { _internalTriggerDelay = d; }
      ...
      private:
        ...
        uint32_t                  _runDelay;
        uint32_t                  _eventCode;
        ProtectionSystemThreshold _protectionThresholds[MaxQuadsPerSensor];
        ...
        uint32_t                  _quadMask;
        uint32_t                  _roiMask;
        ConfigV3QuadReg           _quads[MaxQuadsPerSensor];
    };
